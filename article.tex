...
\addplot3+[ybar, bar width=12pt, fill=blue, draw=none, bar shift=-0.2] 
    coordinates {(1.1,1,85.84) (1,2,80.56) (1,3,70.60) (1,4,66.24)};
\addplot3+[ybar, bar width=12pt, fill=red, draw=none, bar shift=0]  
    coordinates {(1.1,1,89.36) (1,2,84.56) (1,3,79.27) (1,4,71.73)};
\addplot3+[ybar, bar width=12pt, fill=brown, draw=none, bar shift=+0.2] 
    coordinates {(1.1,1,84.96) (1,2,72.03) (1,3,69.73) (1,4,65.55)};
...
\addplot3+[
    ...
    (0.8,1,85.84) (0.8,2,80.56) (0.8,3,70.60) (0.8,4,66.24)
};
...
\addplot3+[ybar, bar width=12pt, fill=blue, draw=none, bar shift=-0.2] 
    coordinates {(2,1,90.70) (2,2,89.84) (2,3,82.72) (2,4,72.47)};
\addplot3+[ybar, bar width=12pt, fill=red, draw=none, bar shift=0]  
    coordinates {(2,1,93.33) (2,2,90.33) (2,3,84.66) (2,4,76.69)};
\addplot3+[ybar, bar width=12pt, fill=brown, draw=none, bar shift=+0.2] 
    coordinates {(2,1,91.67) (2,2,89.92) (2,3,82.25) (2,4,71.76)};
...
\addplot3+[
    ...
    (1.8,1,90.70) (1.8,2,89.84) (1.8,3,82.72) (1.8,4,72.47)
};
...
\addplot3+[ybar, bar width=12pt, fill=blue, draw=none, bar shift=-0.2] 
    coordinates {(3,1,83.72) (3,2,40.62) (3,3,35.66) (3,4,24.07)};
\addplot3+[ybar, bar width=12pt, fill=red, draw=none, bar shift=0]  
    coordinates {(3,1,84.72) (3,2,40.53) (3,3,36.41) (3,4,27.40)};
\addplot3+[ybar, bar width=12pt, fill=brown, draw=none, bar shift=+0.2] 
    coordinates {(3,1,82.58) (3,2,38.30) (3,3,33.93) (3,4,23.33)};
...
\addplot3+[
    ...
    (2.8,1,83.72) (2.8,2,40.62) (2.8,3,35.66) (2.8,4,24.07)
};
...
\begin{figure}[h]
\centering
\includegraphics[width=0.5\textwidth]{example-image} % Uses the default dummy image provided by the graphicx package
